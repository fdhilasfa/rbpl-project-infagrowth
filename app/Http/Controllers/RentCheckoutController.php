...
class RentCheckoutController extends Controller
{
    ...
    public function update($id)
    {
        ...
        if ($rentHistory) {
            $subtotal = preg_replace('/\D/', '', $rentHistory->harga);
            $formattedValue = '...'; // Ganti dengan nilai yang sesuai atau definisikan variabel ini dengan benar
            $shippingCost = preg_replace('/\D/', '', $formattedValue);
